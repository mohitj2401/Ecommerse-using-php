                ...
                $product_id=$_GET['pro_id'];
                 ...
                 while ($row_pro=mysqli_fetch_array($run)) {
                  ...
                  <div class='card-body'>
                   ...
                   <a href='admin_area/product_image/$pro_img1'><img src='admin_area/product_image/$pro_img1' class='img_pro' /></a>
                   <img src='admin_area/product_image/$pro_img2' class='img_pro' />
                   <img src='admin_area/product_image/$pro_img3' class='img_pro' />
